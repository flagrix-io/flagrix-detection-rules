...
Only the latest published version of Flagrix detection rules is actively supported with security updates.
...
https://github.com/flagrix-io/flagrix-detection-rules/security/advisories/new
